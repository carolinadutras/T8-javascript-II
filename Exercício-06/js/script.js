...
// let acessoFinanca = document.querySelectorAll('#transacao__form-group')
// let extrato =document.querySelector('#extrato__header')
// let criarTransacao = document.querySelector('#transacao__button')

// extrato = acessoFinanca.value 
...
// criarTransacao.addEventListener('click', function(evento){
//     let inputFinanca = document.querySelector("#transacaoInputNome");
//     let inputNome = inputFinanca.value;
//     let inputNomeAnterior= document.createElement('p')
//     inputNomeAnterior.textContent= inputNome
// })
